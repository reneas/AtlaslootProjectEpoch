...
local BabbleFaction = AtlasLoot_GetLocaleLibBabble("LibBabble-Faction-3.0")
	...
	-----------------------------
	--- Epoch Lvl 55 PvP Sets ---
	-----------------------------

	AtlasLoot_Data["Epochsetz"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Divined Vestments"], ""};
		{ 2, 61355, "", "=q3=Divined Crown", "=ds=", "20000 #honor#", ""};
		{ 3, 61356, "", "=q3=Divined Mantle", "=ds=", "15000 #honor#", ""};
		{ 4, 61357, "", "=q3=Divined Robe", "=ds=", "20000 #honor#", ""};
		{ 5, 61358, "", "=q3=Divined Gloves", "=ds=", "15000 #honor#", ""};
		{ 6, 61359, "", "=q3=Divined Skirt", "=ds=", "20000 #honor#", ""};
		{ 7, 61360, "", "=q3=Divined Sandals", "=ds=", "10000 #honor#", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Vanta Vestments"], ""};
		{ 17, 61361, "", "=q3=Vanta Mask", "=ds=", "20000 #honor#", ""};
		{ 18, 61362, "", "=q3=Vanta Mantle", "=ds=", "15000 #honor#", ""};
		{ 19, 61363, "", "=q3=Vanta Robe", "=ds=", "20000 #honor#", ""};
		{ 20, 61364, "", "=q3=Vanta Wraps", "=ds=", "15000 #honor#", ""};
		{ 21, 61365, "", "=q3=Vanta Leggings", "=ds=", "20000 #honor#", ""};
		{ 22, 61366, "", "=q3=Vanta Sandals", "=ds=", "10000 #honor#", ""};
		Prev = "Battlemageep1";
		Next = "Epochsetz1";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz1"] = {
		...
		{ 2, 61367, "", "=q3=Shadowcaster Mask", "=ds=", "20000 #honor#", ""};
		{ 3, 61368, "", "=q3=Shadowcaster Mantle", "=ds=", "15000 #honor#", ""};
		{ 4, 61369, "", "=q3=Shadowcaster Robe", "=ds=", "20000 #honor#", ""};
		{ 5, 61370, "", "=q3=Shadowcaster Wraps", "=ds=", "15000 #honor#", ""};
		{ 6, 61371, "", "=q3=Shadowcaster Leggings", "=ds=", "20000 #honor#", ""};
		{ 7, 61372, "", "=q3=Shadowcaster Sandals", "=ds=", "10000 #honor#", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Afflictor"], ""};
		{ 17, 61373, "", "=q3=Afflictor Mask", "=ds=", "20000 #honor#", ""};
		{ 18, 61374, "", "=q3=Afflictor Mantle", "=ds=", "15000 #honor#", ""};
		{ 19, 61375, "", "=q3=Afflictor Robe", "=ds=", "20000 #honor#", ""};
		{ 20, 61376, "", "=q3=Afflictor Wraps", "=ds=", "15000 #honor#", ""};
		{ 21, 61377, "", "=q3=Afflictor Leggings", "=ds=", "20000 #honor#", ""};
		{ 22, 61378, "", "=q3=Afflictor Sandals", "=ds=", "10000 #honor#", ""};
		Next = "Epochsetz2";
		Prev = "Epochsetz";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz2"] = {
		...
		{ 2, 61385, "", "=q3=Astral Cowl", "=ds=", "20000 #honor#", ""};
		{ 3, 61386, "", "=q3=Astral Spaulders", "=ds=", "15000 #honor#", ""};
		{ 4, 61387, "", "=q3=Astral Vest", "=ds=", "20000 #honor#", ""};
		{ 5, 61388, "", "=q3=Astral Gloves", "=ds=", "15000 #honor#", ""};
		{ 6, 61389, "", "=q3=Astral Kilt", "=ds=", "20000 #honor#", ""};
		{ 7, 61390, "", "=q3=Astral Boots", "=ds=", "10000 #honor#", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Barking Armor"], ""};
		{ 17, 61391, "", "=q3=Barking Cowl", "=ds=", "20000 #honor#", ""};
		{ 18, 61392, "", "=q3=Barking Spaulders", "=ds=", "15000 #honor#", ""};
		{ 19, 61393, "", "=q3=Barking Vest", "=ds=", "20000 #honor#", ""};
		{ 20, 61394, "", "=q3=Barking Gloves", "=ds=", "15000 #honor#", ""};
		{ 21, 61395, "", "=q3=Barking Kilt", "=ds=", "20000 #honor#", ""};
		{ 22, 61396, "", "=q3=Barking Boots", "=ds=", "10000 #honor#", ""};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleEpoch["Animalistic Armor"], ""};
		{ 10, 61379, "", "=q3=Animalistic Cowl", "=ds=", "20000 #honor#", ""};
		{ 11, 61380, "", "=q3=Animalistic Spaulders", "=ds=", "15000 #honor#", ""};
		{ 12, 61381, "", "=q3=Animalistic Vest", "=ds=", "20000 #honor#", ""};
		{ 13, 61382, "", "=q3=Animalistic Gloves", "=ds=", "15000 #honor#", ""};
		{ 14, 61383, "", "=q3=Animalistic Kilt", "=ds=", "20000 #honor#", ""};
		{ 15, 61384, "", "=q3=Animalistic Boots", "=ds=", "10000 #honor#", ""};
		Next = "Epochsetz3";
		Prev = "Epochsetz1";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz3"] = {
		...
		{ 2, 61405, "", "=q3=Scouting Cap", "=ds=", "20000 #honor#", ""};
		{ 3, 61406, "", "=q3=Scouting Spaulders", "=ds=", "15000 #honor#", ""};
		{ 4, 61407, "", "=q3=Scouting Tunic", "=ds=", "20000 #honor#", ""};
		{ 5, 61408, "", "=q3=Scouting Gloves", "=ds=", "15000 #honor#", ""};
		{ 6, 61409, "", "=q3=Scouting Pants", "=ds=", "20000 #honor#", ""};
		{ 7, 61410, "", "=q3=Scouting Boots", "=ds=", "10000 #honor#", ""};
		{ 16, 61403, "", "=q3=Wrists of Assault", "=ds=", "10000 #honor#", ""};
		{ 17, 61399, "", "=q3=Belt of Assault", "=ds=", "15000 #honor#", ""};
		Next = "Epochsetz4";
		Prev = "Epochsetz2";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz4"] = {
		...
		{ 2, 61419, "", "=q3=Ranger Cap", "=ds=", "20000 #honor#", ""};
		{ 3, 61420, "", "=q3=Ranger Mantle", "=ds=", "15000 #honor#", ""};
		{ 4, 61421, "", "=q3=Ranger Tunic", "=ds=", "20000 #honor#", ""};
		{ 5, 61422, "", "=q3=Ranger Gloves", "=ds=", "15000 #honor#", ""};
		{ 6, 61423, "", "=q3=Ranger Pants", "=ds=", "20000 #honor#", ""};
		{ 7, 61424, "", "=q3=Ranger Boots", "=ds=", "10000 #honor#", ""};
		{ 16, 61418, "", "=q3=Bindings of Assault", "=ds=", "10000 #honor#", ""};
		{ 17, 61414, "", "=q3=Cord of Assault", "=ds=", "15000 #honor#", ""};
		Next = "Epochsetz5";
		Prev = "Epochsetz3";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz5"] = {
		...
		{ 2, 61431, "", "=q3=Capacitor Coif", "=ds=", "20000 #honor#", ""};
		{ 3, 61432, "", "=q3=Capacitor Pauldrons", "=ds=", "15000 #honor#", ""};
		{ 4, 61433, "", "=q3=Capacitor Vest", "=ds=", "20000 #honor#", ""};
		{ 5, 61434, "", "=q3=Capacitor Gauntlets", "=ds=", "15000 #honor#", ""};
		{ 6, 61435, "", "=q3=Capacitor Kilt", "=ds=", "20000 #honor#", ""};
		{ 7, 61436, "", "=q3=Capacitor Boots", "=ds=", "10000 #honor#", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Tidal Armor"], ""};
		{ 17, 61437, "", "=q3=Tidal Coif", "=ds=", "20000 #honor#", ""};
		{ 18, 61438, "", "=q3=Tidal Pauldrons", "=ds=", "15000 #honor#", ""};
		{ 19, 61439, "", "=q3=Tidal Vest", "=ds=", "20000 #honor#", ""};
		{ 20, 61440, "", "=q3=Tidal Gauntlets", "=ds=", "15000 #honor#", ""};
		{ 21, 61441, "", "=q3=Tidal Kilt", "=ds=", "20000 #honor#", ""};
		{ 22, 61442, "", "=q3=Tidal Boots", "=ds=", "10000 #honor#", ""};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleEpoch["Shockchain Armor"], ""};
		{ 10, 61425, "", "=q3=Shockchain Coif", "=ds=", "20000 #honor#", ""};
		{ 11, 61426, "", "=q3=Shockchain Pauldrons", "=ds=", "15000 #honor#", ""};
		{ 12, 61427, "", "=q3=Shockchain Vest", "=ds=", "20000 #honor#", ""};
		{ 13, 61428, "", "=q3=Shockchain Gauntlets", "=ds=", "15000 #honor#", ""};
		{ 14, 61429, "", "=q3=Shockchain Kilt", "=ds=", "20000 #honor#", ""};
		{ 15, 61430, "", "=q3=Shockchain Boots", "=ds=", "10000 #honor#", ""};
		Next = "Epochsetz6";
		Prev = "Epochsetz4";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz6"] = {
		...
		{ 2, 61467, "", "=q3=Righteous Helm", "=ds=", "20000 #honor#", ""};
		{ 3, 61468, "", "=q3=Righteous Spaulders", "=ds=", "15000 #honor#", ""};
		{ 4, 61469, "", "=q3=Righteous Breastplate", "=ds=", "20000 #honor#", ""};
		{ 5, 61470, "", "=q3=Righteous Gauntlets", "=ds=", "15000 #honor#", ""};
		{ 6, 61471, "", "=q3=Righteous Legplates", "=ds=", "20000 #honor#", ""};
		{ 7, 61472, "", "=q3=Righteous Boots", "=ds=", "10000 #honor#", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Truthful Armor"], ""};
		{ 17, 61473, "", "=q3=Truthful Helm", "=ds=", "20000 #honor#", ""};
		{ 18, 61474, "", "=q3=Truthful Spaulders", "=ds=", "15000 #honor#", ""};
		{ 19, 61475, "", "=q3=Truthful Breastplate", "=ds=", "20000 #honor#", ""};
		{ 20, 61476, "", "=q3=Truthful Gauntlets", "=ds=", "15000 #honor#", ""};
		{ 21, 61477, "", "=q3=Truthful Legplates", "=ds=", "20000 #honor#", ""};
		{ 22, 61478, "", "=q3=Truthful Boots", "=ds=", "10000 #honor#", ""};
		Next = "Epochsetz7";
		Prev = "Epochsetz5";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz7"] = {
		...
		{ 2, 61479, "", "=q3=Plated Helm", "=ds=", "20000 #honor#", ""};
		{ 3, 61480, "", "=q3=Plated Spaulders", "=ds=", "15000 #honor#", ""};
		{ 4, 61481, "", "=q3=Plated Breast", "=ds=", "20000 #honor#", ""};
		{ 5, 61482, "", "=q3=Plated Gauntlets", "=ds=", "15000 #honor#", ""};
		{ 6, 61483, "", "=q3=Plated Legs", "=ds=", "20000 #honor#", ""};
		{ 7, 61484, "", "=q3=Plated Boots", "=ds=", "10000 #honor#", ""};
		Prev = "Epochsetz6";
		Back = "Epochpvp55";
	};

	----------------------------
	--- Epoch Lvl 55 Weapons ---
	----------------------------
	...
	AtlasLoot_Data["EpochpvpS1ConquestTrinkets"] = {
		{ 1, 90605, "", "=q4=Rival's Insignia of the Alliance", "=ds=", "10 #arena# 7 #wsg# 2 #trinketarmorcomp#", ""};
		{ 2, 90606, "", "=q4=Rival's Insignia of the Horde", "=ds=", "10 #arena# 7 #wsg# 2 #trinketarmorcomp#", ""};
		{ 3, 90607, "", "=q4=Rival's Insignia of the Adaption", "=ds=", "10 #arena# 7 #wsg# 2 #trinketarmorcomp#", ""};
		{ 4, 90608, "", "=q4=Rival's Insignia of Relentlessness", "=ds=", "10 #arena# 7 #wsg# 2 #trinketarmorcomp#", ""};
		{ 5, 90609, "", "=q4=Rival's Emblem of Tenacity", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{ 6, 90610, "", "=q4=Rival's Emblem of Vigor", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{ 7, 90611, "", "=q4=Rival's Emblem of Ferocity", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{ 8, 90612, "", "=q4=Rival's Emblem of Magick", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{ 9, 90613, "", "=q4=Rival's Emblem of Cogitation", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{10, 90614, "", "=q4=Rival's Emblem of Betterment", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{11, 90615, "", "=q4=Rival's Emblem of Dominance", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{12, 90616, "", "=q4=Rival's Emblem of Alacrity", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{13, 90617, "", "=q4=Rival's Emblem of Power", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{14, 90618, "", "=q4=Rival's Emblem of Upturn", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		{15, 90619, "", "=q4=Rival's Emblem of Renewal", "=ds=", "50 #arena# 7 #gillijim# 2 #trinketarmorcomp#", ""};
		Back = "EpochpvpS1ConquestMisc";
	};

	--- Cloaks ---
	AtlasLoot_Data["EpochpvpS1ConquestCloaks"] = {
		{1, 90558, "", "=q4=Rival's Cloak of Meditation", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		{2, 90559, "", "=q4=Rival's Cloak of Survival", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		{3, 90560, "", "=q4=Rival's Cloak of Magic Accuracy", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		{4, 90561, "", "=q4=Rival's Cloak of Magic Cruelty", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		{5, 90562, "", "=q4=Rival's Cloak of Magic Potency", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		{6, 90563, "", "=q4=Rival's Cloak of Physical Accuracy", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		{7, 90564, "", "=q4=Rival's Cloak of Physical Cruelty", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		{8, 90565, "", "=q4=Rival's Cloak of Physical Potency", "=ds=", "75 #arena# 7 #gillijim# 2 #clotharmorcomp#", ""};
		Back = "EpochpvpS1ConquestMisc";
	};

	--- Rings ---
	AtlasLoot_Data["EpochpvpS1ConquestRings"] = {
		{1, 90574, "", "=q4=Rival's Band of Meditation", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		{2, 90575, "", "=q4=Rival's Band of Survival", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		{3, 90576, "", "=q4=Rival's Band of Magic Accuracy", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		{4, 90577, "", "=q4=Rival's Band of Magic Cruelty", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		{5, 90578, "", "=q4=Rival's Band of Magic Potency", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		{6, 90579, "", "=q4=Rival's Band of Physical Accuracy", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		{7, 90580, "", "=q4=Rival's Band of Physical Crit", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		{8, 90581, "", "=q4=Rival's Band of Physical Potency", "=ds=", "40 #arena# 10 #wsg# 2 #metalarmorcomp#", ""};
		Back = "EpochpvpS1ConquestMisc";
	};

	--- Necklaces ---
	AtlasLoot_Data["EpochpvpS1ConquestNecks"] = {
		{1, 90586, "", "=q4=Rival's Amulet of Strength", "=ds=", "75 #arena# 7 #gillijim# 2 #metalarmorcomp#", ""};
		{2, 90587, "", "=q4=Rival's Amulet of Agility", "=ds=", "75 #arena# 7 #gillijim# 2 #metalarmorcomp#", ""};
		{3, 90588, "", "=q4=Rival's Amulet of Spellpower", "=ds=", "75 #arena# 7 #gillijim# 2 #metalarmorcomp#", ""};
		{4, 90589, "", "=q4=Rival's Amulet of Meditation", "=ds=", "75 #arena# 7 #gillijim# 2 #metalarmorcomp#", ""};
		Back = "EpochpvpS1ConquestMisc";
	};
